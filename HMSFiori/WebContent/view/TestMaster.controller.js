sap.ui.controller("test.my.fiori.view.TestMaster", {
...
*/
	...
	//
			...
			oEventBus.subscribe("DepartmentDetail", "TabChanged", this.onDetailTabChanged, this);
		...
		//	this.getRouter().attachRoutePatternMatched(this.onRouteMatched, this);
			...
			oEventBus.subscribe("TestDetail", "Changed", this.onDetailChanged, this);
			oEventBus.subscribe("TestDetail", "NotFound", this.onNotFound, this);
},
...
showDetail : function(oItem) {
	...
	this.getRouter().myNavToWithoutHash({ 
		...
		targetViewName : "test.my.fiori.view.TestDetail",
		targetViewType : "XML",
...
handleAddNewRecord:function(oEvent){
	this.getRouter().myNavToWithoutHash({ 
		currentView : this.getView().getParent().oParent.getParent().oParent,
		targetViewName : "test.my.fiori.view.TestCreate",
		targetViewType : "XML",
		context:null,
		appId:"idSplitApp",
	});
