sap.ui.controller("test.my.fiori.view.PatCatMaster", {
...
*/
	onInit: function() {
		...
		//
				...
				oEventBus.subscribe("PatCatDetail", "TabChanged", this.onDetailTabChanged, this);

				var oList = this.getView().byId("list");
			    oList.attachEvent("updateFinished", function() {
					this.oInitialLoadFinishedDeferred.resolve();
					oEventBus.publish("PatCatMaster", "InitialLoadFinished");
				}, this);
			...
			//	this.getRouter().attachRoutePatternMatched(this.onRouteMatched, this);
				...
				oEventBus.subscribe("PatCatDetail", "Changed", this.onDetailChanged, this);
				oEventBus.subscribe("PatCatDetail", "NotFound", this.onNotFound, this);
	},
	...
	showDetail : function(oItem) {
    	...
    	this.getRouter().myNavToWithoutHash({ 
    		...
    		targetViewName : "test.my.fiori.view.PatCatDetail",
    		targetViewType : "XML",
...
//    	var oView =  this.getView().getParent().getParent().getDetailPages()[0];
	...
	handleAddNewRecord:function(oEvent){
		...
		this.getRouter().myNavToWithoutHash({ 
			currentView : this.getView().getParent().oParent.getParent().oParent,
			targetViewName : "test.my.fiori.view.PatCatCreate",
			targetViewType : "XML",
			context:null,
			appId:"idSplitApp",
		});
