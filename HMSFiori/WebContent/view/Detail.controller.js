...
sap.ui.core.mvc.Controller.extend("test.my.fiori.view.Detail", {
...
//		this.getRouter().attachRouteMatched(this.onRouteMatched, this);
	...
	_showFormFragment : function (sFragmentName) {
        ...
        var oFragment = new FragmentFactory()._getRequestedFragment(sFragmentName, oPage, "Initial");
...
//		    }
//
//		    oFormFragment = sap.ui.xmlfragment(this.getView().getId(), "test.my.fiori.fragments." + sFragmentName);
//
...
//		  _formFragments: {},
			onAfterRendering: function(oEvent) {
				debugger;
				 this._showFormFragment("Initial");
			},
});
