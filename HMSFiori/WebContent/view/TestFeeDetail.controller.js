sap.ui.controller("test.my.fiori.view.TestFeeDetail", {
	...
	onInit : function() {
		...
		if (sap.ui.Device.system.phone) {
			...
			oEventBus.subscribe("SexMaster", "InitialLoadFinished",
	...
	_showFormFragment : function(fType) {
		var oPage = this.getView().byId("idDetailPage");
		var sFragmentName = "TestFee_Read";
		if (fType == "Edit") {
			sFragmentName = "TestFee_Edit";
		}
		oPage.removeAllContent();
