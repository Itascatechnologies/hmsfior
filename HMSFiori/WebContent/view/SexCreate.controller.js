sap.ui.controller("test.my.fiori.view.SexCreate", {
...
//	},
	validationName:function(name){
		if(name==""){
			...
			sap.m.MessageToast.show("Please Enter Sex Name");
	            return false;
	    }else if(!isNaN(name)){
	    	this.oAlertDialog.close();
	    	sap.m.MessageToast.show("Please Enter Sex Name  Only In Characters");
	            return false;
	    }
		return true;
	},
	onDialogConfirmed:function(oEvent){
		...
		var bundle = this.getView().getModel("i18n").getResourceBundle();
		 oModel.create('/Sexs', oEntry, null, function(){
