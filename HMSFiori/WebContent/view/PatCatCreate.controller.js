sap.ui.controller("test.my.fiori.view.PatCatCreate", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf view.SexCreate
*/
	onInit: function() {
...
//	},
	validationName:function(name){
		if(name==""){
			...
			sap.m.MessageToast.show("Please Enter Name For Patient Category");
	            return false;
	    }else if(!isNaN(name)){
	    	this.oAlertDialog.close();
	    	sap.m.MessageToast.show("Please Enter Patient Category Name  Only In Characters");
	            return false;
	    }
		return true;
	},
	onDialogConfirmed:function(oEvent){
		...
		oModel.create('/PatientCategoryMasters', oEntry, null, function(){
