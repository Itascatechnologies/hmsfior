sap.ui
		.controller(
				"test.my.fiori.view.RegFeeMaster",
				{
					...
					onInit : function() {
						...
						// this.getRouter().attachRoutePatternMatched(this.onRouteMatched,
						// this);

						oEventBus.subscribe("RegFeeDetail", "Changed",
								this.onDetailChanged, this);
						oEventBus.subscribe("RegFeeDetail", "NotFound",
					...
					onDetailChanged : function(sChanel, sEvent, oData) {
						...
						this
								.waitForInitialListLoading(function() {
									var oList = this.getView().byId("list");
								...
								.myNavToWithoutHash(
										{
											currentView : this.getView()
													.getParent().oParent
													.getParent().oParent,
											targetViewName : "test.my.fiori.view.RegFeeCreate",
											targetViewType : "XML",
											context : null,
											appId : "idSplitApp",
										});
//						var oPages = this.getView().getParent().getParent()
//								.getDetailPages();
								...
								.myNavToWithoutHash(
										{
											currentView : this.getView()
													.getParent().oParent
													.getParent().oParent,
											targetViewName : "test.my.fiori.view.RegFeeDetail",
											targetViewType : "XML",
