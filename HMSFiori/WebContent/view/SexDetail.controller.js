sap.ui.controller("test.my.fiori.view.SexDetail", {
...
*/
	onInit: function(oEvent) {
		...
		this.oInitialLoadFinishedDeferred = jQuery.Deferred();
				...
				if(sap.ui.Device.system.phone) {
					...
					oEventBus.subscribe("SexMaster", "InitialLoadFinished", this.onMasterLoaded, this);
				}
	...
	onRouteMatched : function(oEvent) {
		...
		this.getEventBus().publish("SexDetail", "TabChanged", { sTabKey : sTabKey });
	...
	_showFormFragment : function (fType) {
			    var oPage = this.getView().byId("idDetailPage");
                var sFragmentName ="Sex_Read";
                if(fType=="Edit"){
                	sFragmentName ="Sex_Edit";
                }
			    oPage.removeAllContent();
	...
	toggleNavPage:function(){
		...
		if (sap.ui.Device.system.phone) 
			return { id:"SexMaster",isMaster:true};
		else
