sap.ui.controller("test.my.fiori.view.TestCreate", {
...
//	},
	validationName:function(name){
		if(name==""){
			...
			sap.m.MessageToast.show("Please Enter Name For Test");
	            return false;
	    }else if(!isNaN(name)){
	    	this.oAlertDialog.close();
	    	sap.m.MessageToast.show("Please Enter Test Name  Only In Characters");
	            return false;
	    }
		return true;
	},
	onDialogConfirmed:function(oEvent){
		...
		var bundle = this.getView().getModel("i18n").getResourceBundle();
		 oModel.create('/TestMasters', oEntry, null, function(){
