sap.ui.controller("test.my.fiori.view.NewRegDetail", {
	...
	onInit : function() {
		...
		if (sap.ui.Device.system.phone) {
			...
			oEventBus.subscribe("NewRegMaster", "InitialLoadFinished",
	...
	onRouteMatched : function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(
				jQuery.proxy(function() {
					...
					if (oParameters.name !== "idDetailPage") {
						return;
					}
...
//		oView.byId("cancel").setVisible(bEdit);
		...
		this._showFormFragment("Read");
	},
	_showFormFragment : function(fType) {
		var oPage = this.getView().byId("idDetailPage");
		var sFragmentName = "NewReg_Read";
