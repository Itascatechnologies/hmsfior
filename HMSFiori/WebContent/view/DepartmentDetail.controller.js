sap.ui.controller("test.my.fiori.view.DepartmentDetail", {
	...
	onInit : function() {
		...
		if (sap.ui.Device.system.phone) {
			...
			oEventBus.subscribe("DepartmentMaster", "InitialLoadFinished",
	...
	navBackToMaster:function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "test.my.fiori.view.DepartmentMaster",
			targetViewType : "XML",
			context:null,
			appId:"idSplitApp",
			isMaster:true
	...
	_showFormFragment : function(fType) {
		var oPage = this.getView().byId("idDetailPage");
		var sFragmentName = "Department_Read";
		if (fType == "Edit") {
			sFragmentName = "Department_Edit";
		}
		oPage.removeAllContent();
	...
	navToEmptyViewForWindowCase:function(){
		this.getRouter().myNavToWithoutHash({ 
    		...
    		targetViewName : "test.my.fiori.view."+this.toggleNavPage(),
    		targetViewType : "XML",
    		context:null,
    		appId:"idSplitApp",
    	});
