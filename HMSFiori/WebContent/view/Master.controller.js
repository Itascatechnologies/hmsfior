sap.ui.core.mvc.Controller.extend("test.my.fiori.view.Master", {
...
//		this.getRouter().attachRoutePatternMatched(this.onRouteMatched, this);
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "test.my.fiori.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("FirstName", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
	...
	_showFormFragment : function (sFragmentName) {
        ...
        var oFragment = new FragmentFactory()._getRequestedFragment(sFragmentName, oPage, "SubMenu");
	  ...
	  onAfterRendering: function() {
		  debugger;
		  var fName = this.getView().getBindingContext().sPath.split('/')[1];
		  this._showFormFragment(fName);
	  },
