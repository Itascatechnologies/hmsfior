sap.ui.controller("test.my.fiori.view.TestFeeMaster", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf view.TestFeeMaster
*/
	onInit: function() {
	...
	//
			...
			oEventBus.subscribe("TestFeeDetail", "TabChanged", this.onDetailTabChanged, this);

			var oList = this.getView().byId("list");
		    oList.attachEvent("updateFinished", function() {
				this.oInitialLoadFinishedDeferred.resolve();
				oEventBus.publish("TestFeeMaster", "InitialLoadFinished");
			}, this);
		...
		//	this.getRouter().attachRoutePatternMatched(this.onRouteMatched, this);
			...
			oEventBus.subscribe("TestFeeDetail", "Changed", this.onDetailChanged, this);
			oEventBus.subscribe("TestFeeDetail", "NotFound", this.onNotFound, this);
},
...
handleAddNewRecord:function(oEvent){
	this.getRouter().myNavToWithoutHash({ 
		...
		targetViewName : "test.my.fiori.view.TestFeeCreate",
		targetViewType : "XML",
		context:null,
		appId:"idSplitApp",
	});
...
//	oView.getView().getController()._toggleButtonsAndView(true);
},
...
showDetail : function(oItem) {
	...
	this.getRouter().myNavToWithoutHash({ 
		currentView : this.getView().getParent().oParent.getParent().oParent,
		targetViewName : "test.my.fiori.view.TestFeeDetail",
		targetViewType : "XML",
	...
	oView.getView().getController()._showFormFragment("Read");
},
/**
