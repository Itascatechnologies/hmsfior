sap.ui.controller("test.my.fiori.view.DepartmentMaster", {
...
handleAddNewRecord:function(oEvent){
	this.getRouter().myNavToWithoutHash({ 
		...
		targetViewName : "test.my.fiori.view.DepartmentCreate",
		targetViewType : "XML",
		context:null,
		appId:"idSplitApp",
	});
...
showDetail : function(oItem) {
	...
	this.getRouter().myNavToWithoutHash({ 
		currentView : this.getView().getParent().oParent.getParent().oParent,
		targetViewName : "test.my.fiori.view.DepartmentDetail",
		targetViewType : "XML",
